...
const tweets = T.get('statuses/user_timeline', { screen_name: 'oregonian', count: 10 }, (err, data, response) => {  
  console.log(data);
});
console.log(tweets)
...
// const stream = T.stream('statuses/user_timeline', { screen_name: 'oregonian', count: 10 });
